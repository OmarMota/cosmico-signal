/* =========================================
   Cosmico Signal — Profile types
   Synced with figma_design_token.json
   ========================================= */
...
export interface UserProfile {
  ...
  skill_trajectory: string[] // where user wants to grow (max 3)
  goals: GoalType[]
...
/* =========================================
   Label maps (synced with design tokens)
   ========================================= */
...
/* Specializations per role category */
...
/* Trajectory / growth skills per role */
